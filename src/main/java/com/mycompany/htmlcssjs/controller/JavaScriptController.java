...
public class JavaScriptController {
  ...
  @RequestMapping("/exam12_destructoring_assignment")
  public String exam12DestructoringAssignment() {
    log.info("exam12DestructoringAssignment() 실행");
    return "javascript/exam12_destructoring_assignment";
  }
